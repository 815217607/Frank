...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.access.menus.edit') }}</small>
    </h1>
@endsection

@section('content')
    {!! Form::model($menu,['route' =>['admin.access.menus.update',$menu->id] , 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
                ...
                <div class="col-lg-10">
                    ...
                    <select name="pid" class="form-control">
                        ...
                        @foreach ($pidmenus as $pidmenu)
                            <option value="{!! $pidmenu->id !!}" @if($menu->pid==$pidmenu->id) selected @endif>{!! $pidmenu->menu_name !!}</option>
                        @endforeach
                    </select>
                </div>
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <label>
                        {!! Form::radio('url_falg', '0') !!}路由名</label>
                    <label>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <label> {!! Form::radio('lang_falg', '1') !!}否</label>

                </div>
            </div><!--form control-->
            <div class="form-group">
                {!! Form::label('associated_permissions', trans('validation.attributes.backend.access.menus.associated_permissions'), ['class' => 'col-lg-2 control-label']) !!}
                <div class="col-lg-10">
                    <select name="permission_id" class="form-control">
                        <option value="0">{{ trans('labels.general.none') }}</option>

                        @foreach ($permissions as $permission)
                            <option value="{!! $permission->id !!}" @if($menu->permission_id==$permission->id) selected @endif>{!! $permission->display_name !!}</option>
                        @endforeach
                    </select>
                </div>
            </div><!--form control-->
            ...
            {{--<div class="form-group">--}}
            {{--<label class="col-lg-2 control-label">{{ trans('validation.attributes.backend.access.menus.active') }}</label>--}}
            {{--<div class="col-lg-1">--}}
